  ...
  return (
    <>
      <button
        ...
        className="fixed left-3 top-3 z-40 flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 bg-[#171717] text-white shadow-lg sm:hidden"
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 sm:hidden">
          ...
          />
          <div className="relative z-10 flex h-full w-[85%] max-w-[320px] flex-col overflow-hidden border-r border-white/10 bg-[#171717] text-white">
